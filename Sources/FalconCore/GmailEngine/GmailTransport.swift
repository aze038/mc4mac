...
/// `users.settings.sendAs.list`: an address the account may send as.
public struct GmailSendAs: Decodable, Sendable, Hashable {
    ...
    public init(sendAsEmail: String, displayName: String? = nil, replyToAddress: String? = nil, isPrimary: Bool? = nil,
                isDefault: Bool? = nil, verificationStatus: String? = nil) {
