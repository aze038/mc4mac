...
| The user name a custom account signs in with, which need not be an address | Never included: a failed check of an account's settings is reported with "the account" in its place, while the owner is shown the name |
