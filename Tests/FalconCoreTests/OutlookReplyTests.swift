...
final class OutlookReplyTests: XCTestCase {
    ...
    func testLocaleChild() throws {
        ...
        let history = ReplyHistory(original: original(), html: "<p>Hi</p>", text: "Hi", attribution: .outlook, indent: false, font: .outlook)
    ...
    func testEveryHeadingInAQuotedChainHasOutlooksLineInTheComposer() throws {
        ...
        let history = ReplyHistory(original: original(), html: forward, text: "", attribution: .outlook, indent: false, font: .outlook)
